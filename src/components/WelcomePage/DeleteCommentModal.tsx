...
const DeleteCommentModal :FunctionComponent<Props> = ({ onClose, bdaPostId, commentId }) => {
  const [isDeleted, setIsDeleted] = useState<boolean>(false)
  const deleteForEver = () => {
    deleteBdaComment(bdaPostId, commentId).then(() => {
      setIsDeleted(true)
      onClose()
              ...
              <div className="sm:flex sm:items-start">
                ...
                {!isDeleted
                  ? (<div className="flex flex-col">
                    <p>Etes vous sûr.e.s de vouloir supprimer ce commentaire?</p>
