...
import { updateBdaPost, BdaPost } from '../../services/post.service'
...
interface Props {
  onClose: () => void,
  postToUpdate: BdaPost
}

const ModifyForm:FunctionComponent<Props> = ({ onClose, postToUpdate }) => {
  ...
  const handleSubmit = (values: FormValues) => {
    updateBdaPost(postToUpdate.id, values)
      .then((response) => {
        handleFormSent()
