        ...
        return (
          <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
            ...
            <Form>
              ...
              <div className="relative mt-8 grid grid-cols-2">
                <p>Lien de ma photo de profil</p>
                <Field
                  className="px-3 py-3 placeholder-gray-400 bg-white text-sm focus:outline-none focus:ring border border-black"
                  name='profilPic'
              ...
              <div className="px-4 mt-4 py-3 flex flex-inline align-center">
                <button
                  className="text-black active:bg-gray-700 font-bold px-6 mx-6 py-3 border-2 border-black hover:shadow-lg outline-none focus:outline-none mb-1 w-full"
                  type="submit"
